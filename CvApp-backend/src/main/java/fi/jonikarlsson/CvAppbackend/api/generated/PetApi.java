...
import org.openapitools.api.model.ModelApiResponse;
...
public interface PetApi {
    ...
    default ResponseEntity<Pet> _addPet(
    ...
    default ResponseEntity<Void> _deletePet(
    ...
    default ResponseEntity<List<Pet>> _findPetsByStatus(
    ...
    default ResponseEntity<List<Pet>> _findPetsByTags(
    ...
    default ResponseEntity<Pet> _getPetById(
    ...
    default ResponseEntity<Pet> _updatePet(
        @Parameter(name = "Pet", description = "Pet object that needs to be added to the store", required = true) @Valid @RequestBody Pet pet
    ) {
    ...
    default ResponseEntity<Void> _updatePetWithForm(
    ...
    default ResponseEntity<ModelApiResponse> _uploadFile(
